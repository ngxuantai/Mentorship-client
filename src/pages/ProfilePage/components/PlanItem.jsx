...
function PlanItem() {
  return (
    ...
    <StyledContainer>
        <Row>
            <h3>140$/ month</h3>
            <p>Offering portfolio and case study reviews, interview prepping, white board challenges and more!</p>                    
            <List>
        ...
        <Row>
            <Button className='my-2' variant="secondary">Apply now</Button>
            <List>
                <ListItem className='py-0 px-0'>
                    <ListItemIcon>
                        <Check />
