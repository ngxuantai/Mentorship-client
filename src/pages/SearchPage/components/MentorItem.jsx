    ...
    <StyledContainer fluid>
      <Row className="justify-content-between align-items-start">
        <Col className="flex flex-col items-center justify-between h-full">
          <img
            className="w-[200px] h-[300px] object-cover rounded-full "
            style={{borderRadius: 12}}
            src={mentor.avatar || 'https://picsum.photos/200/300'}
            alt="random image"
          ></img>
          <h6 className="flex items-center">
            <h4 className="font-bold text-primary-900">{mentor.price}</h4>/tháng
          </h6>
        </Col>
        <Col
          md={6}
        ...
        >
          <Row className="">
            ...
            {mentor.ratingCount !== 0 && (
              <div className="flex">
                <Rating value={mentor.ratingStar} disabled />
                <p className=" opacity-50">{mentor.ratingCount} đánh giá</p>
              </div>
            )}
